...
singularity build phylogenetic-tree-collapser_latest.sif docker-daemon://pegi3s/phylogenetic-tree-collapser:latest

singularity run \
      -B ${DATA_DIR}/ptc-cache:/ptc-cache \
      -B ${DATA_DIR}:/data \
      phylogenetic-tree-collapser_latest.sif collapse-tree.py \
