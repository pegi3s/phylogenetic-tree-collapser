...
RUN wget -O /opt/tree-collapser/treecollapse-${PTC_VERSION}-jar-with-dependencies.jar https://maven.sing-group.org/repository/maven-releases/org/sing_group/treecollapse/${PTC_VERSION}/treecollapse-${PTC_VERSION}-jar-with-dependencies.jar


ENV DOCKER_PEGI3S_BIOPYTHON_UTILITIES_VERSION="1.78_0.2.0"
ENV COLLAPSER_JAR_PATH="/opt/tree-collapser/treecollapse-${PTC_VERSION}-jar-with-dependencies.jar"
